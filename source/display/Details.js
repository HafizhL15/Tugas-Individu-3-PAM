...
import { JADWAL, MASKAPAI, BANDARA } from '../database/data.js';
...
const Details = ({ route, navigation }) => {
  ...
  return (
    <>
      ...
      <ImageBackground source={require('../images/2.png')} resizeMode='cover' style={{width:393, height:713}}>

      <Text style={{textAlign:'center', fontSize:33, marginTop:10, color:'white', fontWeight:'bold'}}>Healing.Id</Text>
